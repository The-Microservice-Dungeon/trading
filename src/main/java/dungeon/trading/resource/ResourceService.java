...
public class ResourceService {
  ...
  /**
   * command handler for selling resources does a rest call to robot-service to get the inventory of
   * a robot calculates the price afterwards
   *
  ...
  /**
   * returns all resources with current prices used for the events and rest-calls
   *
   * @return JSONArray
   */
  ...
  /**
   * returns all resources with their complete price history used for the according rest-call
  ...
  /**
   * returns all resources with their complete sell history used for the according rest-call
  ...
  public void createResources() {
    ...
    try {
      ...
      JSONArray resourceArray = (JSONArray) parser.parse(
